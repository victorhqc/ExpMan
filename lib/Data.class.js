...
(function(){
	...
	_Data.prototype.searchRange = function(tableName, index, lower, upper, callback) {
		if(typeof type === 'undefined'){
			type = 'any'; //It could also be "only"
		}
		var tx = this.db.transaction(tableName, "readonly");
		...
		if((lower !== undefined && lower !== null) && (upper !== undefined && upper !== null)){
			var request = index.openCursor(IDBKeyRange.bound(lower, upper));
		}

		//data <= Upper
		if((lower !== undefined && lower !== null) && (upper === undefined || upper === null)){
			var request = index.openCursor(IDBKeyRange.upperBound(upper));
		}

		//data >= Lower		
		if((lower === undefined || lower === null) && (upper !== undefined || upper !== null)){
			var request = index.openCursor(IDBKeyRange.lowerBound(lower));	
		}
